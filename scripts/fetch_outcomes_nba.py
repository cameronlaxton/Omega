"""
scripts/fetch_outcomes_nba.py — attach NBA final scores from ESPN to ungraded traces.
...
Usage:
    ...
    python scripts/fetch_outcomes_nba.py --since 2026-05-10 --until 2026-05-14
    python scripts/fetch_outcomes_nba.py --since yesterday
    python scripts/fetch_outcomes_nba.py --dry-run
