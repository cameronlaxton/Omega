...
def _game_rows(game_id=1):
    return [
        {
            "game_id": game_id, "season": 2025, "game_date": "2025-05-20",
            "team_display_name": "Las Vegas Aces", "opponent_team_display_name": "New York Liberty",
            "home_away": "home", "team_score": 88, "opponent_team_score": 82,
            "field_goals_attempted": 70, "free_throws_attempted": 20,
            "offensive_rebounds": 10, "turnovers": 12,
        },
        {
            "game_id": game_id, "season": 2025, "game_date": "2025-05-20",
            "team_display_name": "New York Liberty", "opponent_team_display_name": "Las Vegas Aces",
            "home_away": "away", "team_score": 82, "opponent_team_score": 88,
            "field_goals_attempted": 72, "free_throws_attempted": 18,
            "offensive_rebounds": 9, "turnovers": 14,
        },
    ]
