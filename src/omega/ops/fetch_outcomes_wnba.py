"""
omega.ops.fetch_outcomes_wnba â€” attach WNBA final scores from ESPN to ungraded traces.

Game-plane twin of fetch_outcomes_nba.py for WNBA. Player props are graded
separately by omega-fetch-outcomes-props (which already supports WNBA);
...
Usage:
    omega-fetch-outcomes-wnba
    omega-fetch-outcomes-wnba --since 2026-05-17 --until 2026-05-17
    omega-fetch-outcomes-wnba --dry-run
