...
TENNIS = SportArchetype(
    ...
    required_player_keys=("name",),
    optional_player_keys=("aces_mean", "double_faults_mean", "games_won_mean", "tiebreaks_won_pct"),
    prop_stat_keys=("aces", "double_faults", "total_games", "sets_won", "tiebreaks"),
    supported_markets=(
        "moneyline",
        "set_spread",
        "total_games",
...
GOLF = SportArchetype(
    ...
    required_player_keys=("name",),
    optional_player_keys=("scoring_avg", "top_10_pct", "made_cut_pct", "win_pct"),
    prop_stat_keys=(
        "finishing_position",
        "top_5",
        "top_10",
...
ESPORTS = SportArchetype(
    ...
    required_player_keys=("name",),
    optional_player_keys=("kills_mean", "deaths_mean", "assists_mean", "kd_ratio", "adr", "rating"),
    prop_stat_keys=("kills", "deaths", "assists", "headshots", "total_rounds", "total_maps"),
    supported_markets=(
        "moneyline",
        "map_spread",
        "total_maps",
...
LEAGUE_TO_ARCHETYPE: dict[str, str] = {
    ...
    "FIFA_INTL": "soccer",  # calibration fit-league/bucket for competitive internationals
    # Tennis
    "ATP": "tennis",
    "WTA": "tennis",
    "GRAND_SLAM": "tennis",
