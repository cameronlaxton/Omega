...
Usage:
    omega-run-champion-challenger [--league NBA] [--json data/cc_out.json]

Data source: src/omega/ops/fixtures/baseline_games.json (or graded TraceStore data if available).
