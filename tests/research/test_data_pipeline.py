...
class TestDataModels:
    def test_source_attribution_defaults(self):
        from omega.evidence.models import SourceAttribution
    ...
    def test_sports_fact_creation(self):
        from omega.evidence.models import SourceAttribution, SportsFact
    ...
    def test_fact_bundle_empty(self):
        from omega.evidence.models import FactBundle
...
class TestSourceConfig:
    def test_direct_api_tier_1(self):
        from omega.evidence.sources.config import get_trust_tier
    ...
    def test_confidence_for_tier(self):
        from omega.evidence.sources.config import get_confidence_for_tier
...
class TestStatNormalizer:
    def test_percentage_normalization(self):
        from omega.evidence.validation.stats import normalize_stat_value
...
class TestSanityValidator:
    ...
    def test_valid_off_rating(self):
        from omega.evidence.validation.sanity import validate_sanity
...
class TestFreshnessValidator:
    def test_fresh_fact_passes(self):
        from omega.evidence.models import SourceAttribution, SportsFact
        from omega.evidence.validation.freshness import validate_freshness
...
class TestFusion:
    ...
    def test_fuse_single_source(self):
        from omega.evidence.models import FactBundle
        from omega.evidence.fusion.fuser import fuse_facts
    ...
    def test_score_confidence(self):
        from omega.evidence.models import FactBundle
        from omega.evidence.fusion.fuser import score_confidence
...
class TestOddsApiClient:
    def test_league_sport_mapping(self):
        from omega.evidence.collectors.odds_api import LEAGUE_SPORT_MAPPING
    ...
    def test_get_sport_key_unsupported(self):
        from omega.evidence.collectors.odds_api import _get_sport_key
        assert _get_sport_key("CURLING") is None

    def test_no_api_key_returns_empty(self):
        from omega.evidence.collectors.odds_api import get_upcoming_odds
        with patch.dict("os.environ", {}, clear=True):
            result = get_upcoming_odds("NBA")
            assert result == []

    def test_extract_consensus_odds(self):
        from omega.evidence.collectors.odds_api import extract_consensus_odds
        games = [{
            "game_id": "abc123",
            "league": "NBA",
            "home_team": "Lakers",
    ...
    def test_check_api_status_no_key(self):
        from omega.evidence.collectors.odds_api import check_api_status
        with patch.dict("os.environ", {}, clear=True):
...
class TestEspnClient:
    def test_league_paths(self):
        from omega.evidence.collectors.espn import LEAGUE_PATHS
    ...
    def test_unsupported_league(self):
        from omega.evidence.collectors.espn import get_todays_games
        result = get_todays_games("CURLING")
        assert result == []

    def test_parse_competitors(self):
        from omega.evidence.collectors.espn import _parse_competitors
        competition = {
            "competitors": [
                {
                    "id": "1",
    ...
    def test_parse_odds(self):
        from omega.evidence.collectors.espn import _parse_odds
        competition = {
            "odds": [
                {
                    "details": "LAL -3.5",
...
class TestSearchClient:
    def test_auto_generate_queries_odds(self):
        ...
        from omega.evidence.collectors.search import _auto_generate_queries
    ...
    def test_try_parse_json_valid(self):
        from omega.evidence.collectors.search import _try_parse_json
    ...
    def test_extract_domain(self):
        from omega.evidence.collectors.search import _extract_domain
    ...
    def test_no_backends_returns_empty(self):
        from omega.core.models import GatherSlot
        from omega.evidence.collectors.search import _execute_search
...
class TestRetrievalOrchestrator:
    def test_session_cache(self):
        from omega.evidence.pipeline.retrieval import _SessionCache
        cache = _SessionCache()
    ...
    def test_retrieve_facts_all_unfilled_no_apis(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            with patch("omega.evidence.collectors.espn.get_todays_games", return_value=[]):
                with patch("omega.evidence.collectors.odds_api.get_upcoming_odds", return_value=[]):
    ...
    def test_retrieve_facts_with_mocked_espn(self):
        ...
        with patch("omega.evidence.collectors.espn.get_todays_games", return_value=mock_games):
