...
import scripts.fit_adjustment_policy as fit_mod
import scripts.promote_adjustment_policy as promote_mod

_SEED_POLICY = (
    Path(__file__).resolve().parents[2]
    / "omega" / "core" / "calibration" / "adjustment_policies.json"
)
