"""
scripts/fetch_outcomes_mlb.py — attach MLB final scores from ESPN to ungraded traces.
...
Usage:
    python scripts/fetch_outcomes_mlb.py
    python scripts/fetch_outcomes_mlb.py --since 2026-05-10 --until 2026-05-14
    python scripts/fetch_outcomes_mlb.py --since yesterday
    python scripts/fetch_outcomes_mlb.py --dry-run
