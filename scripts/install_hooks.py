"""
scripts/install_hooks.py — install tracked git hooks into .git/hooks/.

Copies every hook in scripts/hooks/ into the repo's .git/hooks/ directory and
marks it executable. The tracked copies under scripts/hooks/ are the source of
...
_HOOK_SRC = _REPO_ROOT / "scripts" / "hooks"
