"""
omega.ops.refresh_wehoop â€” load wehoop WNBA history into backtest artifacts.
...
Usage:
    omega-refresh-wehoop --season 2025
    omega-refresh-wehoop --season 2025 --out data/backtest_artifacts/WNBA
...
def main() -> int:
    ...
    if args.dry_run:
        logger.info("Dry run â€” not writing artifacts.")
        return 0
