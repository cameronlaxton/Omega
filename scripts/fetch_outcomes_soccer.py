"""
scripts/fetch_outcomes_soccer.py — attach soccer final scores from ESPN to traces.
...
scores → ``result == "draw"``). This script never touches prop traces.
...
Usage:
    python scripts/fetch_outcomes_soccer.py
    python scripts/fetch_outcomes_soccer.py --since 2026-05-17 --until 2026-05-17
    python scripts/fetch_outcomes_soccer.py --leagues EPL LA_LIGA
    python scripts/fetch_outcomes_soccer.py --dry-run
